...
namespace Xero.Net.Api.Api
{
    ...
    public partial class IdentityApi : IIdentityApi
    {
        ...
        /// <param name="id">Unique identifier for retrieving single object</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Object>> DeleteConnectionAsyncWithHttpInfo (string accessToken, Guid id)
        {
        ...
        {
             Xero.Net.Api.Client.ApiResponse<List<Connection>> localVarResponse = await GetConnectionsAsyncWithHttpInfo(accessToken, authEventId);
        ...
        /// <param name="authEventId">Filter by authEventId (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;Connection&gt;)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<List<Connection>>> GetConnectionsAsyncWithHttpInfo (string accessToken, Guid? authEventId = null)
        {
