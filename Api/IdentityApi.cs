...
using Xero.Net.Api.Model.Identity;
    ...
    public partial class IdentityApi : IIdentityApi
    {
        ...
        public IdentityApi() : this((string) null)
        {
            this.Configuration = Xero.Net.Api.Client.Configuration.MergeConfigurations(
                ...
                new Xero.Net.Api.Client.Configuration { BasePath = "https://api.xero.com" }
            );
        ...
        /// <returns></returns>
        public IdentityApi(Xero.Net.Api.Client.Configuration configuration)
        {
        ...
        public IdentityApi(Xero.Net.Api.Client.ISynchronousClient client,Xero.Net.Api.Client.IAsynchronousClient asyncClient, Xero.Net.Api.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Object>> DeleteConnectionAsyncWithHttpInfo (string accessToken, Guid id, CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Xero.Net.Api.Client.ApiException(400, "Missing required parameter 'id' when calling IdentityApi->DeleteConnection");
        ...
        {
             Xero.Net.Api.Client.ApiResponse<List<Connection>> localVarResponse = await GetConnectionsAsyncWithHttpInfo(accessToken, authEventId, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation token enables cancellation between threads. Defaults to CancellationToken.None</param>
        /// <returns>Task of ApiResponse (List&lt;Connection&gt;)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<List<Connection>>> GetConnectionsAsyncWithHttpInfo (string accessToken, Guid? authEventId = null, CancellationToken cancellationToken = default)
        {
            ...
            if (authEventId != null)
            {
                foreach (var kvp in Xero.Net.Api.Client.ClientUtils.ParameterToMultiMap("", "authEventId", authEventId))
                {
