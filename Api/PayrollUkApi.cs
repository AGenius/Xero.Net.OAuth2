...
namespace Xero.Net.Api.Api
{
    ...
    public partial class PayrollUkApi : IPayrollUkApi
    {
        ...
        {
             Xero.Net.Api.Client.ApiResponse<Timesheets> localVarResponse = await GetTimesheetsAsyncWithHttpInfo(accessToken, xeroTenantId, page, filter);
             return localVarResponse.Data;
        ...
        /// <param name="filter">Filter by first name and/or lastname (optional)</param>
        /// <returns>Task of ApiResponse (Timesheets)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Timesheets>> GetTimesheetsAsyncWithHttpInfo (string accessToken, string xeroTenantId, int? page = null, string filter = null)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
