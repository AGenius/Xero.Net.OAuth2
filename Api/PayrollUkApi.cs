...
namespace Xero.Net.Api.Api
{
    ...
    public partial class PayrollUkApi : IPayrollUkApi
    {
        ...
        {
             Xero.Net.Api.Client.ApiResponse<Employees> localVarResponse = await GetEmployeesAsyncWithHttpInfo(accessToken, xeroTenantId, filter, page);
             return localVarResponse.Data;
        ...
        /// <param name="page">Page number which specifies the set of records to retrieve. By default the number of the records per set is 100. (optional)</param>
        /// <returns>Task of ApiResponse (Employees)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Employees>> GetEmployeesAsyncWithHttpInfo (string accessToken, string xeroTenantId, string filter = null, int? page = null)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
             Xero.Net.Api.Client.ApiResponse<Timesheets> localVarResponse = await GetTimesheetsAsyncWithHttpInfo(accessToken, xeroTenantId, page, filter, status, startDate, endDate, sort);
             return localVarResponse.Data;
        ...
        /// <param name="sort">sort the order of timesheets returned. The default is based on the timesheets createdDate, sorted oldest to newest. Currently, the only other option is to reverse the order based on the timesheets startDate, sorted newest to oldest. (optional)</param>
        /// <returns>Task of ApiResponse (Timesheets)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Timesheets>> GetTimesheetsAsyncWithHttpInfo (string accessToken, string xeroTenantId, int? page = null, string filter = null, string status = null, string startDate = null, string endDate = null, string sort = null)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
