...
namespace Xero.Net.Api.Api
{
    ...
    public partial class BankFeedsApi : IBankFeedsApi
    {
        ...
        {
             Xero.Net.Api.Client.ApiResponse<FeedConnections> localVarResponse = await CreateFeedConnectionsAsyncWithHttpInfo(accessToken, xeroTenantId, feedConnections);
        ...
        /// <param name="feedConnections">Feed Connection(s) array object in the body</param>
        /// <returns>Task of ApiResponse (FeedConnections)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<FeedConnections>> CreateFeedConnectionsAsyncWithHttpInfo (string accessToken, string xeroTenantId, FeedConnections feedConnections)
        {
        ...
        {
             Xero.Net.Api.Client.ApiResponse<Statements> localVarResponse = await CreateStatementsAsyncWithHttpInfo(accessToken, xeroTenantId, statements);
             return localVarResponse.Data;
        ...
        /// <param name="statements">Statements array of objects in the body (optional)</param>
        /// <returns>Task of ApiResponse (Statements)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Statements>> CreateStatementsAsyncWithHttpInfo (string accessToken, string xeroTenantId, Statements statements = null)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
             Xero.Net.Api.Client.ApiResponse<FeedConnections> localVarResponse = await DeleteFeedConnectionsAsyncWithHttpInfo(accessToken, xeroTenantId, feedConnections);
             return localVarResponse.Data;
        ...
        /// <param name="feedConnections">Feed Connections array object in the body</param>
        /// <returns>Task of ApiResponse (FeedConnections)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<FeedConnections>> DeleteFeedConnectionsAsyncWithHttpInfo (string accessToken, string xeroTenantId, FeedConnections feedConnections)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
             Xero.Net.Api.Client.ApiResponse<FeedConnection> localVarResponse = await GetFeedConnectionAsyncWithHttpInfo(accessToken, xeroTenantId, id);
             return localVarResponse.Data;
        ...
        /// <param name="id">Unique identifier for retrieving single object</param>
        /// <returns>Task of ApiResponse (FeedConnection)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<FeedConnection>> GetFeedConnectionAsyncWithHttpInfo (string accessToken, string xeroTenantId, Guid id)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
             Xero.Net.Api.Client.ApiResponse<FeedConnections> localVarResponse = await GetFeedConnectionsAsyncWithHttpInfo(accessToken, xeroTenantId, page, pageSize);
             return localVarResponse.Data;
        ...
        /// <param name="pageSize">Page size which specifies how many records per page will be returned (default 10). Example - https://api.xero.com/bankfeeds.xro/1.0/FeedConnections?pageSize&#x3D;100 to specify page size of 100. (optional)</param>
        /// <returns>Task of ApiResponse (FeedConnections)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<FeedConnections>> GetFeedConnectionsAsyncWithHttpInfo (string accessToken, string xeroTenantId, int? page = null, int? pageSize = null)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
             Xero.Net.Api.Client.ApiResponse<Statement> localVarResponse = await GetStatementAsyncWithHttpInfo(accessToken, xeroTenantId, statementId);
             return localVarResponse.Data;
        ...
        /// <param name="statementId">statement id for single object</param>
        /// <returns>Task of ApiResponse (Statement)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Statement>> GetStatementAsyncWithHttpInfo (string accessToken, string xeroTenantId, Guid statementId)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
             Xero.Net.Api.Client.ApiResponse<Statements> localVarResponse = await GetStatementsAsyncWithHttpInfo(accessToken, xeroTenantId, page, pageSize, xeroApplicationId, xeroUserId);
             return localVarResponse.Data;
        ...
        /// <param name="xeroUserId"> (optional, default to &quot;00000000-0000-0000-0000-0000030000000&quot;)</param>
        /// <returns>Task of ApiResponse (Statements)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Statements>> GetStatementsAsyncWithHttpInfo (string accessToken, string xeroTenantId, int? page = null, int? pageSize = null, string xeroApplicationId = null, string xeroUserId = null)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
