...
namespace Xero.Net.Api.Api
{
    ...
    public partial class AssetApi : IAssetApi
    {
        ...
        {
            Xero.Net.Api.Client.ApiResponse<Asset> localVarResponse = await CreateAssetAsyncWithHttpInfo(accessToken, xeroTenantId, asset);
        ...
        /// <param name="asset">Fixed asset you are creating</param>
        /// <returns>Task of ApiResponse (Asset)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Asset>> CreateAssetAsyncWithHttpInfo(string accessToken, string xeroTenantId, Asset asset)
        {
        ...
        {
            Xero.Net.Api.Client.ApiResponse<AssetType> localVarResponse = await CreateAssetTypeAsyncWithHttpInfo(accessToken, xeroTenantId, assetType);
            return localVarResponse.Data;
        ...
        /// <param name="assetType">Asset type to add (optional)</param>
        /// <returns>Task of ApiResponse (AssetType)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<AssetType>> CreateAssetTypeAsyncWithHttpInfo(string accessToken, string xeroTenantId, AssetType assetType = null)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
            Xero.Net.Api.Client.ApiResponse<Asset> localVarResponse = await GetAssetByIdAsyncWithHttpInfo(accessToken, xeroTenantId, id);
            return localVarResponse.Data;
        ...
        /// <param name="id">fixed asset id for single object</param>
        /// <returns>Task of ApiResponse (Asset)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Asset>> GetAssetByIdAsyncWithHttpInfo(string accessToken, string xeroTenantId, Guid id)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
            Xero.Net.Api.Client.ApiResponse<Setting> localVarResponse = await GetAssetSettingsAsyncWithHttpInfo(accessToken, xeroTenantId);
            return localVarResponse.Data;
        ...
        /// <param name="xeroTenantId">Xero identifier for Tenant</param>
        /// <returns>Task of ApiResponse (Setting)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Setting>> GetAssetSettingsAsyncWithHttpInfo(string accessToken, string xeroTenantId)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
            Xero.Net.Api.Client.ApiResponse<List<AssetType>> localVarResponse = await GetAssetTypesAsyncWithHttpInfo(accessToken, xeroTenantId);
            return localVarResponse.Data;
        ...
        /// <param name="xeroTenantId">Xero identifier for Tenant</param>
        /// <returns>Task of ApiResponse (List&lt;AssetType&gt;)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<List<AssetType>>> GetAssetTypesAsyncWithHttpInfo(string accessToken, string xeroTenantId)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
        ...
        {
            Xero.Net.Api.Client.ApiResponse<Assets> localVarResponse = await GetAssetsAsyncWithHttpInfo(accessToken, xeroTenantId, status, page, pageSize, orderBy, sortDirection, filterBy);
            return localVarResponse.Data;
        ...
        /// <param name="filterBy">A string that can be used to filter the list to only return assets containing the text. Checks it against the AssetName, AssetNumber, Description and AssetTypeName fields. (optional)</param>
        /// <returns>Task of ApiResponse (Assets)</returns>
        public async System.Threading.Tasks.Task<Xero.Net.Api.Client.ApiResponse<Assets>> GetAssetsAsyncWithHttpInfo(string accessToken, string xeroTenantId, AssetStatusQueryParam status, int? page = null, int? pageSize = null, string orderBy = null, string sortDirection = null, string filterBy = null)
        {
            // verify the required parameter 'xeroTenantId' is set
            if (xeroTenantId == null)
