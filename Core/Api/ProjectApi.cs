...
namespace Xero.Net.Core.Api
{
    ...
    public class ProjectApi : Xero.Net.Api.Api.ProjectApi, ICoreAPI
    {
        ...
        public List<Xero.Net.Api.Model.Project.Project> Projects(int? onlypage = null, List<Guid> projectIds = null, Guid? contactID = null, string states = null, int pageSize = 50)
        {
            int? page = 1;
            ...
            try
            {
                var records = new List<Xero.Net.Api.Model.Project.Project>(); // Hold the records
        ...
        public Xero.Net.Api.Model.Project.Project Project(Guid projectID)
        {
            if (projectID == null)
            {
